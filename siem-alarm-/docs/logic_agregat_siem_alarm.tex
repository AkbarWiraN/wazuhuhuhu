...
sama berjalan bersamaan. Systemd \code{RuntimeMaxSec=240s} membatasi durasi agar run
tidak bertumpuk dengan jadwal berikutnya.
...
\midrule
Cluster & -- & \code{cluster\_composite\_ops\_ro} dan envelope bulk yang dibutuhkan.\\
...
\begin{itemize}[label=$\square$]
  ...
  \item Load test dua kali peak memenuhi p95 dan RuntimeMaxSec.
